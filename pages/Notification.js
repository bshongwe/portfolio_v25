...
const Notification = (props) => {
  ...
  return (
    <div className="container">
      <Head>
        <title>My Notifications -Ernest Portfolio Website</title>
        <meta
          name="description"
          content="Stay informed with notifications on the Ernest Portfolio Website. Receive updates on new projects, blog articles, and community interactions. Customize your notification preferences to ensure you never miss important announcements and stay connected with the latest in the creative and technology world."
        />
