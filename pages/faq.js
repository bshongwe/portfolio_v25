...
const questions = [
  ...
  },
  {
    ...
    answer:
      "Yes, I know. Please message me for more info. contact me in https://www.facebook.com/shongwe.bhekizwe/",
  },
  {
    id: 2252523,
...
function FAQ() {
  ...
  return (
    <>
      <Head>
        <title> FAQ | Questions | Answers - Ernest Portfolio Website</title>
        <meta
          name="description"
          content=" FAQ | Questions | Answers - Ernest Portfolio Website . Explore the frequently asked questions and get answers on Ernest's captivating portfolio website. Find information on web development, design, coding, and technology. Gain insights into the creative mind behind the website. Optimized for easy navigation and user satisfaction."
        />
      </Head>
