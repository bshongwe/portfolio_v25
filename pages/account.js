...
const AccountUser = (props) => {
  ...
  return (
    <>
      <Head>
        <title>My Account -Ernest Portfolio Website</title>
        <meta
          name="description"
          content="Manage your Ernest Portfolio and Blog account: Update your profile, track your projects, and engage with the community. Access exclusive features, personalized recommendations, and stay connected with the latest web development, design, coding, and technology trends. Optimized for Googlebot indexing and ranking."
        />
        <meta
          name="description"
          content="Discover Ernest's Identity: Explore a captivating personal portfolio and blog showcasing the talent, expertise, and journey of Ernest. Dive into the world of web development, design, coding, and technology through engaging articles, projects, and insights. Get to know the creative mind behind the website. Optimized for Googlebot indexing and ranking."
        />
        <meta
          name="description"
          content="Ernest Personal Portfolio and Blog|Ernest Portfolio Website: Explore a comprehensive collection of web development, design, coding, and technology insights. Enhance your career growth with projects, tips, and personal branding strategies. Engage with Ernest's professional expertise and unlock your digital potential. Optimized for Googlebot indexing and ranking."
        />
        ...
        <div class="cols__container">
          <div class="left__col">
            ...
            <div class="content-profile">
              ...
              <ul>
                <Link href={"https://www.facebook.com/shongwe.bhekizwe/"}>
                  {" "}
                  <Facebook />
                </Link>

                <Instagram />
                <Link href={"https://www.github.com/bshongwe"}>
                  <GitHub />
                </Link>
                <Twitter />
                <WhatsApp />
