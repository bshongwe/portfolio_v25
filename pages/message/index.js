...
const Messages = () => {
  ...
  return (
    <ChakraProvider>
      <Head>
        <title>Messages -Ernest Portfolio Website</title>
        <meta
          name="description"
          content="Stay connected and engage in meaningful conversations on the Ernest Portfolio Website messages page. Connect with fellow creatives, professionals, and enthusiasts to share ideas, collaborate on projects, and foster connections. Designed for seamless communication and accessible to Google bot count, our messages page provides a secure and interactive platform to connect and exchange messages with the community. Discover new opportunities, build relationships, and fuel your creative journey through engaging discussions and collaborations."
        />
