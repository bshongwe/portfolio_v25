...
The main challenge was getting the pipeline's check points to pass (all green
checks). Debugging the deployed model became easier once this was handled.

## Outcome

The model's accuracy gradually increased, by atleast 15% from first deployment
