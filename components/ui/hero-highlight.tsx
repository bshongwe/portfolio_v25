...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none bg-dot-thick-indigo-500 dark:bg-dot-thick-indigo-500   absolute inset-0 opacity-100 transition duration-300 group-hover:opacity-100"
        style={{
